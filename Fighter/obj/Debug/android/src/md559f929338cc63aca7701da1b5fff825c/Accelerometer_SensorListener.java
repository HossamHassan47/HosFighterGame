package md559f929338cc63aca7701da1b5fff825c;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Devices.Sensors.Accelerometer+SensorListener, MonoGame.Framework, Version=3.6.0.641, Culture=neutral, PublicKeyToken=null", Accelerometer_SensorListener.class, __md_methods);
	}
	...
	public Accelerometer_SensorListener () throws java.lang.Throwable
	{
		...
		if (getClass () == Accelerometer_SensorListener.class)
			mono.android.TypeManager.Activate ("Microsoft.Devices.Sensors.Accelerometer+SensorListener, MonoGame.Framework, Version=3.6.0.641, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
